...
def get_MELD_loaders(batch_size=32, num_workers=0, pin_memory=False):
...
def train_or_eval_model(model,
    ...
    for data in dataloader:
        ...
        log_prob = model(r, x5, x6, x1, o2, o3, qmask, umask, att2=False)
...
if __name__ == '__main__':
    ...
    if args.class_weight:
        if args.mu > 0:
            ...
            loss_weights = torch.FloatTensor([
                0.30427062, 1.19699616, 5.47007183, 1.95437696, 0.84847735,
                5.42461417, 1.21859721
            ])
    ...
    dir = path.cwd()
    lf = open(dir / 'train/logs/cosmic_meld_emotion_logs.txt', 'a')
    ...
    rf = open(dir / 'train/results/cosmic_meld_emotion_results.txt', 'a')
