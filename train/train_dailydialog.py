...
def train_or_eval_model(model,
    ...
    avg_fscore1 = round(
        f1_score(labels,
                 ...
                 sample_weight=masks,
                 average='micro',
                 labels=[0, 2, 3, 4, 5, 6]) * 100, 2)
    avg_fscore2 = round(
        f1_score(labels, preds, sample_weight=masks, average='macro') * 100, 2)
    fscores = [avg_fscore1, avg_fscore2]

    return avg_loss, avg_accuracy, [fscores]
...
if __name__ == '__main__':
    ...
    print('DailyDialog DeCOCO Model.')
